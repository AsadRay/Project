                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="City Bank"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Dus Bangla Bank"></asp:ListItem>
                                <asp:ListItem Value="3" Text="One Bank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Perimer Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Standard Bank"></asp:ListItem>
                            </asp:DropDownList>
